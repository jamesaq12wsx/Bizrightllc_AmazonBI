...
<%--  Use to export datatable to excel  --%>
<script src="<%=path %>/page/production/vendors/datatables.net/js/jszip.min.js"></script>
<%--  Use to add buttons on datatable  --%>
<script src="<%=path %>/page/production/vendors/datatables.net/js/dataTables.buttons.min.js"></script>
<script src="<%=path %>/page/production/vendors/datatables.net/js/buttons.flash.min.js"></script>
...
<script type="text/javascript">
    ...
    function injectCustomJs_custom() {
        return;
