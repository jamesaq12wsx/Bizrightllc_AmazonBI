		...
		success:function(value){
			...
			if (data.status == '1') {
				...
				$.each(data.data,function(index){
					...
					if(this.week_day=="Monday")series_data[0]=this.xiaoliang
					if(this.week_day=="Tuesday")series_data[1]=this.xiaoliang
					if(this.week_day=="Wednesday")series_data[2]=this.xiaoliang
					if(this.week_day=="Thursday")series_data[3]=this.xiaoliang
					if(this.week_day=="Friday")series_data[4]=this.xiaoliang
					if(this.week_day=="Saturday")series_data[5]=this.xiaoliang
					if(this.week_day=="Sunday")series_data[6]=this.xiaoliang
				})
				 // 使用刚指定的配置项和数据显示图表。
				echart2.setOption({
				    grid: {
