...
/**
 * 使用java.security.MessageDigest类写的一个工具类用来获取MD5码 MD5Util.java
 * 
 */
public class MD5Util {
	...
	public static String getMD5(String code) {
		...
		if(stringBuilder.length() > 32){
			stringBuilder = new StringBuilder(stringBuilder.toString().substring(0, 32));
		}
	...
	public static void main(String[] args) {
		System.out.println(MD5Util.getMD5("88888888"));
	}
}
