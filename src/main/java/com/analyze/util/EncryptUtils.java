...
public class EncryptUtils {
	...
	public static void main(String[] args) {
		String AESKey="YINGYAN20170303!";//要求16位
		String source = "26A6483B81E35DE5EFE948803B785E3F";//在此输入需要解锁的密文
		try {
			String strc = EncryptUtils.encryptToAES(AESKey, "yanming123");
			System.out.println("AES加密后为:" + strc);
			// 使用这个密匙解密
			String strd = EncryptUtils.decryptByAES(AESKey, source);
