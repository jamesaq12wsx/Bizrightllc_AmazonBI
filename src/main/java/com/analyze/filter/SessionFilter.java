...
/**
 * Session filter
 * This filter check the session of request
 * if not authorize redirect to login page
 * 
 * @author wei
 *
 */
...
//		logger.debug(String.format("[doFilter] Request: %s, Session: %s", url, session.getId()));
